...
$in="INSERT INTO table123  VALUES ('$f','$a','$b','$c','$ems','$d','$e','$menuarray1[0]','$menuarray1[1]','$menuq1',     '$menuarray2[0]','$menuarray2[1]','$menuq2','$menuarray3[0]','$menuarray3[1]','$menuq3','$menuarray4[0]','$menuarray4[1]','$menuq4','$menuarray5[0]',           '$menuarray5[1]','$menuq5','$menuarray6[0]','$menuarray6[1]','$menuq6','$menuarray7[0]','$menuarray7[1]','$menuq7')";
    ...
    <div id="container">
      ...
      <div class="clearfix"></div>
        ...
        <table cellpadding="0" cellspacing="0">
          ...
          <tr>
            <th></th>
            <th>DATE : <?php echo $f; ?></th> 
            <th>VISITING TIME : <?php echo $b; ?></th>
            <th>PERSONS : <?php echo $a; ?></th>  
      </tr></table></section>
      <section id="items">
...
<?php
$to       = "$ems,foodiecrunchtables@gmail.com";
$subject  = 'INVOICE';
      ...
      <section id="items">
        ...
        <table cellpadding="0" cellspacing="0">
          ...
          <tr >
            ...
            <tr >
            <td>7.</td> <!--SERIAL NOS --> <!-- Dont remove this column as its needed for the row commands -->
