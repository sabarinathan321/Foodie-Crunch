...
$con=mysqli_connect($host,$un,$p,$db);
  ...
  if($el1==$st1)
  {
  $ins="INSERT INTO register VALUES('$fn1','$ln1','$el1','$st1')";
...
<body class="red" background="images/b1.jpg">


  <div id="login-page" class="row">
    <div class="col s12 z-depth-6 card-panel">
      <form class="login-form" action="booking.php" method="post">
        <div class="row">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input class="validate" id="email" type="email" name="emaill">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input id="password" type="password" name="passl">
